...
function CardPassagem({
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div
        className={`w-full h-full max-w-2xl mx-auto rounded-3xl transition-colors duration-300 ${outerBgClass}`}
      >
        <div className="bg-white relative drop-shadow-2xl rounded-3xl p-6 m-5 flex flex-col">
          <div className="flex-grow">
            ...
            <div className="flex items-center justify-between gap-5">
              <div className="w-2/5">
                ...
                <p
                  className={`text-lg font-bold ${textColorClass} break-words`}
                >
                  {carona?.origem}
                </p>
              </div>
