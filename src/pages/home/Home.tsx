    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="rides" className="py-16">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-4xl font-bold text-blue-900 mb-8 text-center">Caronas Próximas</h2>
            ...
            {rides.map((ride) => (
              <div key={ride.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition">
                ...
                <div className="mb-2">
                  ...
                  <p><strong>Para:</strong> {ride.to}</p>
                </div>
      ...
      <section id="location" className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h3 className="text-4xl font-bold text-blue-900 mb-6 text-center">Sugestões para você</h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              { city: 'Campinas', reason: 'Rota popular para quem sai de SP', rides: 12 },
              { city: 'Santos', reason: 'Muito procurada nos fins de semana', rides: 8 },
              { city: 'São José dos Campos', reason: 'Ideal para viagens a trabalho', rides: 10 },
            ].map((suggestion, index) => (
              <div key={index} className="bg-blue-50 p-6 rounded-lg shadow hover:shadow-lg transition">
                <h4 className="text-xl font-semibold text-blue-800 mb-1">{suggestion.city}</h4>
                <p className="text-gray-700 text-sm mb-1">{suggestion.reason}</p>
                <p className="text-gray-600 text-sm">Caronas disponíveis: <strong>{suggestion.rides}</strong></p>
              </div>
            ))}
          </div>

          <h4 className="text-3xl font-bold text-blue-900 mb-6 text-center">O que estão dizendo</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {[
              { name: "João M.", rating: 5, comment: "Excelente serviço! Motorista muito pontual." },
              { name: "Fernanda R.", rating: 4, comment: "Boa experiência, mas o app poderia mostrar mais detalhes da rota." },
              { name: "Lucas A.", rating: 5, comment: "Super recomendo! Fácil de usar e seguro." },
            ].map((review, index) => (
              <div key={index} className="bg-white border border-blue-100 p-6 rounded-lg shadow-md hover:shadow-lg transition">
          ...
          <div className="flex flex-col lg:flex-row gap-10 justify-center items-center">
            <div className="w-full lg:w-1/2 max-w-lg border-2 border-blue-200 rounded-lg p-6 shadow-md bg-gray-50">
              <h4 className="text-2xl font-semibold mb-4 text-blue-900">Contatos e Suporte</h4>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-gray-800">Atendimento: Seg-Sex, 08h às 18h</p>
                </div>
                <div className="flex items-center space-x-3">
                  <MapPin className="w-6 h-6 text-blue-600" />
                  <p className="text-gray-800">Sede: Av. Paulista, São Paulo - SP</p>
                </div>
              </div>
            </div>
