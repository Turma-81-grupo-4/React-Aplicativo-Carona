...
function Login() {
  ...
  return (
    <>
      <div
        className="pt-20 relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          >
            <form onSubmit={login} className="space-y-6">
              ...
              <div className="text-center mb-8">
                <h2
                  className="text-4xl font-bold bg-gradient-to-r from-orange-400 via-blue-400 to-orange-400 
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  />
                  <div
                    className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-500/20 to-blue-500/20 
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  />
                  <div
                    className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 to-orange-500/20 
                                              opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                  ></div>
                </div>
              </div>
          ...
          <div
            className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-3/4 h-8 
                               bg-gradient-to-r from-orange-500/30 to-blue-500/30 blur-xl rounded-full"
          ></div>
        </div>
      </div>
    </>
