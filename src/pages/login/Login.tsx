...
function Login() {
  ...
  return (
    <>
      <div
        className="bg-gradient-to-t from-gray-800 to-gray-400 grid grid-cols-1 lg:grid-cols-2 
                    h-screen place-items-center font-bold "
      >
        <div className="fundoLogin hidden lg:block"></div>
        <form
          className="bg-gray-300 py-4 px-2 border-4 border-gray-800 flex justify-center items-center flex-col w-1/2 gap-4"
          onSubmit={login}
        >
